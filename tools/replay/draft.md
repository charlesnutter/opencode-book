...
unintended changes. By default it sets file edits and bash commands to `ask`, so
...
The second way is markdown files. You can define agents using markdown, placed
either globally or per project, in an agents directory. The markdown file name
