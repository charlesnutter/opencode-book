<!--opencode-book
{
  "built_at": "2026-08-19T04:39:04+00:00",
  "claims_rejected": 0,
  "claims_used": 30,
  "corpus_commit": "040b8561400fcbe84eaf8d045ede46fc014e2d00",
  "fingerprint": "80b90c8326394118c7120dcfd74a79142f837b9a891c5b93f6ef19cadc7cbe34",
  "models": {
    "draft": "qwen3-30b-a3b-instruct-2507@http://localhost:1234/v1?t=0.4",
    "extract": "qwen3-30b-a3b-instruct-2507@http://localhost:1234/v1?t=0.1",
    "verify": "qwen3-30b-a3b-instruct-2507@http://localhost:1234/v1?t=0.0",
    "voice": "qwen3-30b-a3b-instruct-2507@http://localhost:1234/v1?t=0.7"
  }
}
-->
...
- **Agents** — [https://opencode.ai/docs/agents](https://opencode.ai/docs/agents)
  - Sections: [Types](https://opencode.ai/docs/agents#types), [Primary agents](https://opencode.ai/docs/agents#primary-agents), [Subagents](https://opencode.ai/docs/agents#subagents), [Built-in](https://opencode.ai/docs/agents#built-in), [Usage](https://opencode.ai/docs/agents#usage), [Configure](https://opencode.ai/docs/agents#configure), [JSON](https://opencode.ai/docs/agents#json), [Markdown](https://opencode.ai/docs/agents#markdown), [Model](https://opencode.ai/docs/agents#model), [Prompt](https://opencode.ai/docs/agents#prompt), [Permissions](https://opencode.ai/docs/agents#permissions), [Max steps](https://opencode.ai/docs/agents#max-steps)
  - Pinned at commit [`040b8561`](https://github.com/anomalyco/opencode/blob/040b8561400fcbe84eaf8d045ede46fc014e2d00/packages/web/src/content/docs/agents.mdx)
